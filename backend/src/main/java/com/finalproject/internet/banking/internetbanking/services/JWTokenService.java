...
public class JWTokenService {
    ...
    public String generateToken(User user) {
        try {
            ...
            return JWT.create()
                .withIssuer("Internet Banking API") // Emissor do token 
                .withSubject(user.getCpf())         // Identifica o utilizador (email) 
                .withExpiresAt(expirationDate())    // Define o tempo de expiração  
